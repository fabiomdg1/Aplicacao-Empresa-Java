...
const routes: Routes = [
  ...
  {path: "cadastroFuncionario", component:CadastroFuncionarioSemCargoComponent},
  //Editar
  ...
  {path: "exclusaoFuncionario/:id_funcionario/:id_cargo", component:ExclusaoFuncionarioComponent}
